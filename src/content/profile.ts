export const profile = {
  ...
  experience: [
    {
      ...
      bullets: {
        ...
        en: [
          "Built web solutions using HTML, CSS/SASS, JavaScript, Angular, CodeIgniter (PHP), and Microsoft SQL Server.",
          "Supported requirements gathering, functional documentation, and QA testing.",
          "Collaborated with the team and coordinated priorities/timelines for the “Corrida Financiera Casas” project."
        ]
      },
  ...
  certifications: [
    "React Avanzado (Platzi, Sep 17, 2025)",
    "Node.js Avanzado (Platzi, Aug 2, 2025)"
  ]
};
